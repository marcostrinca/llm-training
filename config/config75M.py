...
N_EMBED = 512              # Dimension of the embedding space
N_HEAD = 8 #16                # Number of attention heads in each transformer block
N_BLOCKS = 8 #64               # Number of transformer blocks in the model
...
T_OUT_PATH = "models/transformer_3B_veracruz.pt"  # Path to save the trained model
