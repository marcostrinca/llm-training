...
CONTEXT_LENGTH = 1024        # Maximum sequence length for the model
N_EMBED = 1536              # Dimension of the embedding space
...
TRAIN_PATH = "data/train/pile_train_veracruz_1M.h5"  # File path for the training dataset
...
T_OUT_PATH = "models/transformer_1M.pt"  # Path to save the trained model
